...
- [ ] **Consolidate Legacy Folders**: Move `biology_reasearch`, `life`, `life-1`, `life-paper`, `research_repo` into `archive/`. These appear to be duplicate or older versions of the project.
- [ ] **Fix Typos**: Rename any clearly typoed directories (e.g., `biology_reasearch`) if they are kept or archived.
