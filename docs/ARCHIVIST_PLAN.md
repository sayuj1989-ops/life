...
- [x] **Archive Redundant Content**: Identify and move unused code to `archive/`.
    - *Decision*: Moved `models/` (legacy prototypes) to `archive/legacy_models/`.
    - *Decision*: Moved `edited_sections/` (draft TeX files) to `archive/legacy_manuscript_drafts/edited_sections_v2/`.
