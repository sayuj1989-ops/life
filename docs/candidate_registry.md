...
| 3 | **DMD** | 100 | **Thermodynamic_Cost**: Essential for maintenance of muscle tone against gravity; loss leads to collapse. | Connects cytoskeleton to ECM (costamere), protecting muscle from contraction-induced mechanical damage and gravity load. |
...
| 6 | **MYLK** | 100 | **Thermodynamic_Cost**: Regulator of myosin contractility. | Regulates smooth/non-muscle motility and contractility via myosin phosphorylation. |
