...
- **Best Case:** 6 Weeks (Submit May 01). Assumes data is found quickly (1 week).
- **Expected:** 8 Weeks (Submit May 15). Allows 3 weeks for data gathering/proxy estimation.
