...
**Target:** *Nature* / *Spine* Submission
**Timeline:** 6 Weeks (March 13 - May 01, 2026)

## Phase 1: Data Gathering & Code (Weeks 1-2: March 13 - March 27)
...
## Phase 2: Manuscript Polish & Theory (Weeks 3-4: March 28 - April 10)
...
## Phase 3: Review & Submission (Weeks 5-6: April 11 - May 01)

- [ ] **Internal Review:** PI Review of full package (Manuscript + Supp Info).
- [ ] **Pre-Submission:** Run `SUBMISSION_MASTER_CHECKLIST.md`.
- [ ] **Submission:** Submit to *Nature* / *Spine*.

## Gantt Chart

| Week | Task | Owner | Status |
| :--- | :--- | :--- | :--- |
| **Week 1 (Mar 13)** | Species Data Collection | **CRITICAL** | 🚨 **Starting** |
| **Week 2 (Mar 20)** | Cross-Species Script & Plot | Comp Bio | ⚪ Planned |
| **Week 3 (Mar 27)** | Figure Assembly (1-7) | PI / Design | ⚪ Planned |
| **Week 4 (Apr 03)** | Manuscript Final Text | PI | ⚪ Planned |
| **Week 5 (Apr 10)** | Internal Review & Polish | Team | ⚪ Planned |
| **Week 6 (Apr 17)** | **SUBMISSION** | PI | ⚪ Planned |
