...
\begin{itemize}
    ...
    \item \textbf{Molecular Asymmetry}: AlphaFold analysis reveals that mechanosensory proteins (mean anisotropy 3.08) are structurally expensive, while their metabolic regulators are intrinsically disordered and fragile --- a 72\% gap ($p = 0.011$).
