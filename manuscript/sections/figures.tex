...
\begin{figure}[h!]
    ...
    \caption{\textbf{Counter-Curvature as a Thermodynamic Standing Wave.} (A) \textbf{Passive Gravitational Prior}: In the absence of active biological correction, mechanical equilibrium under gravity dictates a low-energy, monotonic C-shaped sag (blue curve). (B) \textbf{Active Counter-Curvature Posterior}: Driven by developmental signals (e.g., HOX genes), the growing organism acts as a ``smart beam,'' expending metabolic energy ($P_{\mathrm{counter}}$) to construct and maintain an active, high-energy S-shaped standing wave (orange curve) that opposes gravity. (C) \textbf{Thermodynamic Buckling and the Energy Deficit Window}: During the rapid adolescent growth spurt, the thermodynamic cost of maintaining this active state against gravity scales to the fourth power of length ($L^4$), vastly outpacing the diffusive nutrient supply ($L^2$). Unable to afford the metabolic cost of high-anisotropy vector sensors (e.g., Piezo2, Lamin A/C), the sensory apparatus fails. The system undergoes ``Metabolic Buckling,'' spontaneously collapsing into a lower-energy, gravity-dominated scoliotic helix to minimize energy dissipation.}
