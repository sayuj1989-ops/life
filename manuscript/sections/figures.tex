...
\begin{figure}[h!]
    ...
    \caption{\textbf{The Biological Counter-Curvature Mechanism.} (A) \textbf{The Developmental Code}: Discrete HOX gene expression domains (colored bars) define positional identity along the spinal axis, creating a digital ``map'' of the body plan. (B) \textbf{The Information Field}: This digital code is smoothed into a continuous scalar information field $I(s)$ (blue curve), which acts as a morphogenetic potential. (C) \textbf{Metric Distortion and Stability}: The information field modifies the material metric $g_{\mathrm{eff}}(s)$, effectively ``dilating'' the rest geometry to create an active counter-curvature. This structure acts as a "standing wave" that neutralizes the passive gravitational moment, stabilizing the functional S-shaped posture as the energetic ground state against geometric collapse.}
