...
\begin{figure}[h!]
    ...
    \caption{\textbf{The Biological Counter-Curvature Mechanism.} (A) HOX gene expression domains (colored bars) define a discrete positional code along the spinal axis. (B) This code is smoothed into a continuous scalar information field $I(s)$ (blue curve), acting as a ``morphogenetic potential''. (C) The information field modifies the material metric $g_{\mathrm{eff}}(s)$, effectively "dilating" space in the cervical and lumbar regions. This induces an intrinsic rest curvature (counter-curvature) that opposes the gravitational tendency to sag, stabilizing the S-shaped posture.}
