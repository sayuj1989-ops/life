...
\begin{figure}[h!]
    ...
    \caption{\textbf{Biological Counter-Curvature and the Thermodynamic Tax.} (A) \textbf{Passive Gravitational Prior}: In the absence of active correction, gravity dictates a low-energy, monotonic C-shaped sag (blue curve). (B) \textbf{Active Counter-Curvature}: Biological growth, guided by "Genetic Priors" (HOX genes) and mechanosensory feedback, generates an S-shaped standing wave (orange curve) that actively opposes gravitational deformation. This high-energy state requires continuous metabolic work ($P_{\mathrm{counter}}$) to maintain high-anisotropy sensors. (C) \textbf{The Gravity Paradox}: During the adolescent growth spurt, the mechanical demand of maintaining this geometry scales as $L^4$, while diffusive nutrient supply scales only as $L^2$. This divergence creates an \textbf{Energy Deficit Window}. In this regime, structurally expensive "Vector Sensors" (e.g., Piezo2, Lamin A/C) impose an unsustainable "Thermodynamic Tax"~\cite{lynch2015bioenergetic} and are downregulated, triggering a "Vector-Scalar Mismatch" and collapse into the low-energy scoliotic mode.}
