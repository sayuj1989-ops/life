...
\begin{figure}[h!]
    ...
    \caption{\textbf{Thermodynamic Collapse: The Energy Deficit Window.} (A) The metabolic power $P_{\mathrm{counter}}$ (red) required to maintain the Counter-Curvature active standing wave scales invariantly with spinal length ($L^0$). (B) In contrast, the diffusive nutrient supply capacity of the avascular intervertebral disc (blue) scales sub-linearly. The intersection at $L_{\mathrm{crit}} = 0.35$~m marks the onset of the \textbf{Energy Deficit Window} ($L < L_{\mathrm{crit}}$). In this regime, the metabolic cost of "Active Inference" (maintaining geometric targets against gravity) outstrips the supply, triggering a \textbf{Convective Shutdown}~\cite{sato2025convective}. This metabolic insolvency forces a transition from a stable, information-driven S-shape to a chaotic, gravity-driven buckling mode (scoliosis), driven by the stabilization of HIF-1$\alpha$ and the loss of stiffness anisotropy.}
