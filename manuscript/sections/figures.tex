...
\begin{figure}[h!]
    ...
    \caption{\textbf{Information-driven Counter-Curvature as Active Inference.}
    (A) Curvature profiles showing the transition from the passive gravitational ``prior'' (blue) to the active S-shaped posterior (orange), achieved by minimizing the total potential energy $U_{CC}$ (analogous to Free Energy).
