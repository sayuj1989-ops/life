...
% Figure 6: Clinical Validation
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_clinical_validation.png}
    \caption{\textbf{Clinical Validation of Scoliosis Onset.} Comparison of model-predicted Cobb angle progression (red line) with historical clinical cohorts (Weinstein 1983, Lonstein 1984). The model, driven solely by the Energy Deficit mechanism ($L^4$ demand vs $L^2$ supply mismatch), reproduces the sudden divergence in spinal curvature observed at the onset of the pubertal growth spurt (age 10-11, vertical dashed line). The critical length $L_{\mathrm{crit}} \approx 0.35$~m corresponds to the age of onset, validating the \textbf{Thermodynamic Buckling} hypothesis.}
