...
\begin{figure}[h!]
    ...
    \caption{\textbf{Thermodynamic Collapse: The Energy Deficit Window.} (A) The metabolic power $P_{\mathrm{counter}}$ (red) required to maintain the Counter-Curvature active standing wave scales with spinal length as $L^2$ (assuming isometric growth) or $L^3$ (volumetric tone). (B) In contrast, the nutrient supply capacity of the avascular intervertebral disc (blue) scales sub-linearly ($L^{0.5}$ to $L^1$). The intersection at $L_{\mathrm{crit}} \approx 0.35$~m marks the onset of the \textbf{Energy Deficit Window} ($L > L_{\mathrm{crit}}$), forming a wedge-shaped instability region in the $(\chi_\kappa, L)$ phase space. Structural analysis of \textbf{Thermodynamic Cost Proteins} (Table 2) reveals the molecular basis of this deficit: high-anisotropy sensors like Piezo2 and Lamin A/C (demand-side) are structurally expensive ``Tension Rods''~\cite{alberts2002molecular}, while compact supply-side enzymes (PLOD1, MMPs) are cheaper but rate-limited ``Blocky Scaffolds''~\cite{gautieri2011collagen}. In the deficit regime, the system cannot afford the high-fidelity state, triggering a \textbf{Convective Shutdown}~\cite{sato2025convective} and a collapse into the low-energy scoliotic mode.}
