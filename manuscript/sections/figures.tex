...
\begin{figure}[h!]
    ...
    (C) Geodesic deviation $\widehat{D}_{\mathrm{geo}}$ scales with coupling strength; stability requires $\chi_\kappa$ to exceed a critical threshold dependent on $\Lambda_{crit}$.
