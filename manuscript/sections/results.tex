...
Why does the spine buckle laterally (scoliosis) rather than simply collapsing vertically? Our vector field analysis (Fig.~\ref{fig:protein_landscape}) identifies the \textbf{Vector-Scalar Mismatch} as the localizing mechanism.
