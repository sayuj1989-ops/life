...
The Energy Deficit Window simulation confirms this dynamic: the thermodynamic cost of counter-curvature $P_{\mathrm{counter}}(L)$ scales explicitly as $L^2$, whereas the proprioceptive supply capacity scales sublinearly as $L^{0.5}$ (Fig.~\ref{fig:energy_deficit_window}). This differential scaling inevitably results in an intersection at the critical length $L_{\mathrm{crit}} \approx 0.35$~m, beyond which the deficit sharply accelerates and creates a physical vulnerability window that aligns tightly with clinical progression stages.
