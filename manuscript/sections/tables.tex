...
\begin{table}[h!]
\centering
\caption{Thermodynamic cost proteins (n=16) grouped by dissipation term and characterized by AlphaFold structural metrics. The anisotropy ratio and morphology indicate the structural cost of maintaining orientation (vector sensing) vs. volume (scalar maintenance). See Eq.~\ref{eq:dissipation} for term definitions.}
