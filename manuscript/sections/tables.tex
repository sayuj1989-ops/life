...
\begin{table}[h!]
\centering
\caption{List of thermodynamic cost proteins ($n=22$) mapped to the three dissipation terms ($\eta_p, \eta_a, \Gamma_m$) from the free energy dissipation functional (Eq.~\ref{eq:dissipation}). Metrics include Anisotropy Ratio, Morphology, AlphaFold pLDDT, Residue count, and L-Scaling behavior.}
\label{tab:thermodynamic_cost_proteins_table2}
\scriptsize
\begin{tabular}{llcclllc}
\toprule
\textbf{Gene} & \textbf{UniProt} & \textbf{Dissipation Term} & \textbf{Anisotropy} & \textbf{Morphology} & \textbf{pLDDT} & \textbf{Residues} & \textbf{L-Scaling} \\
\midrule
\multicolumn{8}{l}{\textit{Proprioceptive Feedback ($\eta_p$)}} \\
...
PIEZO1 & Q92508 & $\eta_p$ & 3.90 & Fibrous/Extended & 72.0 & 2521 & $L^2$ \\
\midrule
\multicolumn{8}{l}{\textit{Active Moment Maintenance ($\eta_a$)}} \\
...
CAV1 & Q03135 & $\eta_a$ & 3.98 & Fibrous/Extended & 78.4 & 178 & $L^2$ \\
\midrule
\multicolumn{8}{l}{\textit{Basal Tissue Maintenance ($\Gamma_m$)}} \\
COL1A1 & P02452 & $\Gamma_m$ & 2.80 & Intermediate & 52.7 & 1464 & $L^3$ \\
COMP & P49747 & $\Gamma_m$ & 1.72 & Intermediate & 88.1 & 757 & $L$ \\
SIRT1 & Q96EB6 & $\Gamma_m$ & 1.73 & Intermediate & 65.0 & 747 & Constant \\
SOX9 & P48436 & $\Gamma_m$ & 2.19 & Intermediate & 56.0 & 509 & $L$ \\
