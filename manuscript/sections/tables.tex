...
\begin{table}[h!]
\centering
\caption{List of 16 thermodynamic cost proteins grouped by dissipation term, referencing the free energy dissipation functional (Eq.~\ref{eq:dissipation}).}
...
\multicolumn{8}{l}{\textit{Basal Metabolic Maintenance ($\Gamma_m$)}} \\
