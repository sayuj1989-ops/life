...
\begin{table}[h!]
\centering
\caption{Table of 16 thermodynamic cost proteins grouped by dissipation term ($\eta_p, \eta_a, \Gamma_m$) and characterized by AlphaFold structural metrics. The anisotropy ratio and morphology indicate the structural cost of maintaining orientation (vector sensing) vs. volume (scalar maintenance). The free energy dissipation functional is defined in the Theory section. This table lists the 16 key proteins analyzed in this study, prioritizing high-confidence metabolic targets (Score 100) identified in the counter-curvature pipeline.}
