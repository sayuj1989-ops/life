...
Allometric Scaling & $Bg$ vs. Body Mass & Exponent = $-0.282 \pm 0.072$ \newline $R^2 = 0.744$ \newline Deviation from $-0.25$: $0.032$ \newline $95\%$ CI (Bootstrap): $[-0.325, -0.102]$ & $p = 1.31 \times 10^{-3}$ \newline (Strong) \\
Bayesian Model Comparison & IEC Model vs. Null Model & $\Delta$BIC = $11.73$ \newline Bayes Factor $\approx 352$ & Overwhelming Evidence \\
\midrule
...
Clinical Validation of $L_{crit}$ & $L_{crit} \approx 0.35$m mapping to WHO age & Mapped Age: $12.04$ years & Matches $11-14$ year AIS peak \\
Anisotropy Rescue Effect & $L_{crit}$ vs. Anisotropy & $R^2 = 0.775$ \newline Saturation at $\ge 6.0$ & $p = 3.58 \times 10^{-17}$ \newline (Strong) \\
Protein Structure Confidence & Demand vs. Supply Anisotropy & Excludes low-confidence (pLDDT $< 70$) & Mann-Whitney U: $p = 0.133$ \newline (Requires Validation) \\
\midrule
