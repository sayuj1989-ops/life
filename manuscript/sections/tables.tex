...
\begin{table}[h!]
\centering
\caption{Summary of the 16 thermodynamic cost proteins mapped to the three dissipation terms of the free energy functional (Eq.~\ref{eq:dissipation}). Data includes AlphaFold structural metrics and scaling behavior with spinal length $L$.}
...
\midrule
\multicolumn{8}{l}{\textit{Basal Maintenance ($\Gamma_m$)}} \\
