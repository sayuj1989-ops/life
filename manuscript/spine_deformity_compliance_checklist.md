...
|---|---|---|---|
| 1 | Structured abstract ≤ 250 words | ✅ | ~175 words (Purpose + Methods + Results + Conclusions) |
| 2 | Title ≤ 120 characters, clinically legible | ✅ | "The Derivative Gain Gap: A Delayed-Feedback Control Model for Adolescent Idiopathic Scoliosis" — 91 characters |
| 3 | Level of evidence statement present | ✅ | "Not applicable (computational modeling study)" on title page |
| 4 | Assumptions subsection in Methods | ✅ | "Assumptions and Parameterization Limits" subsection with parameter table and transparency sentences |
| 5 | Limitations paragraph in Discussion | ✅ | Discussion §5.4 — six-point limitations paragraph covering single-plane model, no patient data, postulated parameters, population-mean growth, simplified brace model, assumed sex-differential β |
| 6 | Validation roadmap in Discussion | ✅ | Discussion §5.5 — three concrete next steps: prospective posturography, Risser/Sanders staging comparison, direct proprioceptive delay measurement during PHV |
