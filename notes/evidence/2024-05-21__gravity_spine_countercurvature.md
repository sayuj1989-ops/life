...
*   **Pathway:** Mechanical stress -> PIEZO2 channel opening -> Ca$^{2+}$ influx -> Depolarization of proprioceptors -> CNS feedback loop -> Muscle tone adjustment.
...
*   **Coupling ($\chi_M$):** The coupling constant represents the gain of the feedback loop. If PIEZO2 is defective, $\chi_M -> 0$ or becomes aberrant.
