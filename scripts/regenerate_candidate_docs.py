...
def main():
    ...
    with open(DOC_FILE, 'w') as f:
        ...
        f.write("****Last Updated:** Week 9 Cycle - Gravity Expansion V (Added HDAC4, TRPM7, COL12A1, etc.)\n")
        ...
        f.write("## Next Steps\n\n")
        f.write("1.  **AlphaFold Analysis**: Run the \"Bolt-BioFold\" pipeline on the top new candidates (HDAC4, TRPM7, COL12A1) to assess structural anisotropy.\n")
        f.write("2.  **Simulation**: Investigate the role of stiffness anisotropy (COL12A1) in the `pyelastica` rod models.\n")
        f.write("3.  **Literature Review**: Deep dive into the \"Mechanosensitive Repression\" mechanism for HDAC4.\n")
