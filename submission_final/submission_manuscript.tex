...
While direct in vivo measurement of protein-level metabolic flux during rapid growth remains technically challenging, the energetic scaling laws derived here provide a robust theoretical bound that necessitates this structural failure, independent of specific molecular pathways. The convergence of allometric scaling, protein thermodynamics, and mechanical simulation strongly suggests that the deformity is an inevitable consequence of pushing a biological material beyond its metabolic yield point.
...
\bibitem{pourquie2011vertebrate} Pourquié, O. Vertebrate segmentation: from cyclic gene networks to scoliosis. \textit{Cell} \textbf{145}, 650–663 (2011).
\bibitem{gazzola2018forward} Gazzola, M., Dudte, L.H., McCormick, A.G. \& Mahadevan, L. Forward and inverse problems in the mechanics of soft filaments. \textit{R. Soc. Open Sci.} \textbf{5}, 171628 (2018).
\bibitem{weinstein2008adolescent} Weinstein, S.L., Dolan, L.A., Cheng, J.C.Y., Danielsson, A.J. \& Morcuende, J.A. Adolescent idiopathic scoliosis. \textit{Lancet} \textbf{371}, 1527–1537 (2008).
\bibitem{cheng2015ais} Cheng, J.C.Y. et al. Adolescent idiopathic scoliosis. \textit{Nat. Rev. Dis. Primers} \textbf{1}, 1–20 (2015).
\bibitem{moulton2013morphoelastic} Moulton, D.E., Lessinnes, T. \& Goriely, A. Morphoelastic rods. Part I: A single growing elastic rod. \textit{J. Mech. Phys. Solids} \textbf{61}, 398–427 (2013).
\bibitem{sharon2002buckling} Sharon, E. \& Efrati, E. Buckling cascades in free sheets. \textit{Nature} \textbf{419}, 579 (2002).
\bibitem{engler2006matrix} Engler, A.J., Sen, S., Sweeney, H.L. \& Discher, D.E. Matrix elasticity directs stem cell lineage specification. \textit{Cell} \textbf{126}, 677–689 (2006).
\bibitem{swift2013nuclear} Swift, J. et al. Nuclear lamin-A scales with tissue stiffness and enhances matrix-directed differentiation. \textit{Science} \textbf{341}, 1240104 (2013).
\bibitem{panciera2017mechanobiology} Panciera, T., Azzolin, L., Cordenonsi, M. \& Piccolo, S. Mechanobiology of YAP/TAZ in physiology and disease. \textit{Nat. Rev. Mol. Cell Biol.} \textbf{18}, 758–770 (2017).
\bibitem{kou2013lbx1} Kou, I. et al. Genetic variants in LBX1 are associated with adolescent idiopathic scoliosis. \textit{Nat. Genet.} \textbf{45}, 676–679 (2013).
\bibitem{gadelha2013counterbend} Gadelha, H. et al. Counterbend phenomena in flagellar mechanics. \textit{Proc. Natl. Acad. Sci. U.S.A.} \textbf{110}, 12180–12185 (2013).
\end{thebibliography}
